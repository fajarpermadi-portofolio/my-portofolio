  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100 text-slate-900">
      ...
      <section id="projects" className="max-w-6xl mx-auto p-6 mt-16">
        ...
        <p className="text-slate-600 mt-2">Hasil project yang telah saya buat (belum layak industri). Saya sedang belajar agar kemampuan saya siap membuat project berstandar industri.</p>
